...
public class EditSkippedDevice extends AppCompatActivity {
...
//      Modify the database
    ...
    //            Log.d("TEST",m.getLocation_area_id());
            ...
            SkippedDevicesActivity.devices.clear();
            SkippedDevicesActivity.devices.addAll(devices);
            SkippedDevicesActivity.mAdapter.notifyDataSetChanged();
