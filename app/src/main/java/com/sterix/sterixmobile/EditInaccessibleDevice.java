...
public class EditInaccessibleDevice extends AppCompatActivity {
...
//        Log.d("NUMBA",v.getTag(R.id.device_position).toString());
        ...
        // Sorry ang bobo ng pagka-code nito. Inaantok lang talaga yung developer. Pls understand. :(
...
//            int pos = Integer.parseInt(position);
                ...
                insertDeviceMonitoringToServer(service_order_id, device_code, m.getLocation_area_id(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()), device_condition_id_val, activity_id_val);
            } else {


                insertDeviceMonitoringToQueue(service_order_id, device_code, m.getLocation_area_id(), new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date()), device_condition_id_val, activity_id_val);
