...
public class SkippedDevicesByAreaExpandActivity extends AppCompatActivity {

    String service_order_location,service_order_id,location_area_id,position,device_id,device_code,client_location_area_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        service_order_id = i.getStringExtra("SERVICE_ORDER_ID");
        client_location_area_id  = i.getStringExtra("CLIENT_LOCATION_AREA_ID");

        recyclerView = (RecyclerView) findViewById(R.id.summary_recyclerview);

        devices = fetchDevices(service_order_id);

        mAdapter = new DeviceSummaryAdapter(devices);
...
//        Log.d("LOCATION_AREA_ID",location_area_id);
        ...
        String selectionArgs[] = {service_order_id,client_location_area_id};
    ...
    public void editDevice(View v){
        ...
        Intent editInaccessibleDeviceIntent = new Intent(getApplicationContext(), EditSkippedDeviceByArea.class);
