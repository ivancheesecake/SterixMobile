...
public class DevicesMonitoringSummaryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DevicesSummaryAdapter(devices);
...
//        Log.d("LOCATION_AREA_ID",location_area_id);
        ...
        String selection = SterixContract.DeviceMonitoring.COLUMN_SERVICE_ORDER_ID +" = ?";
